...
Az eszköz fejlesztése során törekedtem arra, hogy a funkcionalitás ahol csak lehet a MagicDraw-n belül történjen. Ehhez szükséges volt magában a modellben is eltárolni információkat, mint például az ellenőrizendő követelmények vagy a Back-annotation.
Ennek eléréséhez készítettem egy UML profilt. Ez három részből áll.
...
Ahhoz, hogy a formális verifikáció végrehajtható legyen ki kell választani, hogy milyen modelleket szeretnénk ellenőrizni és ezeken milyen követelményeket. Ezeket az információkat magában a modellben tárolom el egyéb az technológiák és az infrastruktúra sajátosságaiból adódó információkkal együtt.
