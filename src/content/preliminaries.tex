...
Talán érdemes elsőre utánanézni, hogy milyen már létező eszközök állnak rendelkezésre. Bár a MagicDraw specifikus eszközről nem tudok, ami még most is releváns lenne, általánosabban az állapottérkép és formális verifikációval kapcsolatban a legszorosabban kapcsolódó munka, amit a dolgozat során sokszor említeni fogok a Gamma Statechart Compoition Framework amelyet későbbi fejezetekben mutatok be. A megoldások amiket alkalmaztam főleg ennek az eszköznek a segítségével történtek.
